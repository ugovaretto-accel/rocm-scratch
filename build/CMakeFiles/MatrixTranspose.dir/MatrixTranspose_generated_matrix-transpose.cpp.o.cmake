...
set(HIP_HIPCC_EXECUTABLE "/opt/rocm/hip/bin/hipcc") # path
set(HIP_HIPCONFIG_EXECUTABLE "/opt/rocm/hip/bin/hipconfig") #path
set(HIP_HOST_COMPILER "/usr/tce/packages/clang/clang-11.0.0/bin/clang++") # path
set(CMAKE_COMMAND "/usr/tce/packages/cmake/cmake-3.14.5/bin/cmake") # path
set(HIP_run_make2cmake "/opt/rocm/hip/cmake/FindHIP/run_make2cmake.cmake") # path
set(HCC_HOME "") #path
set(HIP_CLANG_PATH "/opt/rocm/llvm/bin") #path
set(HIP_CLANG_PARALLEL_BUILD_COMPILE_OPTIONS "")


set(HIP_HIPCC_FLAGS -fPIC;-D__HIP_ROCclr__=1 -D__HIP_PLATFORM_HCC__=1 -D__HIP_ROCclr__=1)
...
set(HIP_HIPCC_INCLUDE_ARGS -I/opt/rocm-3.10.0/hip/../include -I/usr/tce/packages/clang/clang-11.0.0/lib/clang/11.0.0/include/.. -I/opt/rocm-3.10.0/hip/include -I/opt/rocm-3.10.0/include) # list

set(cmake_dependency_file "/g/g92/varetto1/projects/rocm-scratch/build/CMakeFiles/MatrixTranspose.dir//MatrixTranspose_generated_matrix-transpose.cpp.o.depend") # path
set(source_file "/g/g92/varetto1/projects/rocm-scratch/matrix-transpose.cpp") # path
